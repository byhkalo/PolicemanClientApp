...
class MyEmergenciesViewModel {
  // MARK: - Properties
  /// Handler
  var emergenciesUpdateHandler: EmergenciesUpdateHandler?
  var navigationTitle: String { return "My Emergencies" }
...
private extension MyEmergenciesViewModel {
...
extension MyEmergenciesViewModel {
  func recalculateEmergencies() {
    ...
    presentingModels = emergenciesCollection.compactMap({ (emergencyModel) -> Emergency? in
      ...
      return isContain ? tempEmergency : nil
    })
    emergenciesUpdateHandler?(.emergenciesUpdated)
  }
}
// MARK: - Extension AnyMyEmergenciesViewModel
extension MyEmergenciesViewModel: AnyEmergenciesViewModel {
...
extension MyEmergenciesViewModel: AnyEmergenciesCollectionViewModel {
